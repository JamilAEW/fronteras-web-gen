      ...
      <div className="md:hidden">
        <StaggeredMenu
          ...
          items={[
            ...
            { label: 'Cursos', ariaLabel: 'Ver cursos', link: '/cursos' },
            { label: '¿Quiénes somos?', ariaLabel: 'Conocer más', link: '/quienes-somos' },
            { label: 'Contacto', ariaLabel: 'Contactar', link: '/contacto' }
          ]}
          socialItems={[
            { label: 'WhatsApp', link: 'https://wa.link/eaetlq' },
            { label: 'Portal Virtual', link: 'https://portal.educarsinfronteras.es/acceso.cgi' }
          ]}
          displaySocials={true}
          ...
          colors={['hsl(var(--primary) / 0.1)', 'hsl(var(--primary) / 0.2)']}
        />
      </div>
