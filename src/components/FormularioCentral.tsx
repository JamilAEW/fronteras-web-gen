  ...
  return <section ref={ref as React.RefObject<HTMLElement>} className={`relative py-20 bg-primary transition-all duration-1000 ${isVisible ? 'opacity-100 blur-0' : 'opacity-0 blur-sm'}`}>
      ...
      <div className="max-w-3xl mx-auto px-4 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-md mx-auto">
          ...
          <Button type="submit" variant="secondary" size="lg" className="w-full bg-brand-yellow text-primary hover:bg-brand-yellow hover:scale-105 hover:brightness-95 hover:shadow-xl transition-all duration-300">
            Inscríbete aquí
          </Button>
        </form>
      </div>
